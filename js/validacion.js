function Numeros(string){     //Solo recibir números en el input
	var out = '';
    var filtro = '1234567890';  // Estos son los caracteres válidos
...
function NumText(string){       //Recibir letras y numeros en el input
	var out = '';
    ...
    var separador=" ";  
    var prueba= separador+filtro;		
	 
    //Estos son los caracteres válidos
	
    for (var i=0; i<string.length; i++)
       if (prueba.indexOf(string.charAt(i))!= -1) 
		   out +=string.charAt(i);
		 return out;
